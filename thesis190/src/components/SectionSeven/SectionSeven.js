...
const SectionSeven = () => (
  <>
    ...
    <div className={style.container}>
      ...
      work was done, an attack on some of the field’s lowest-paid people. There
    ...
    <div className={style.container}>
      ...
      I had emailed with Mira Trenchard, the scout whose inbox had seemingly
      been compromised. However they knew, the thief was aware of my efforts and
    ...
    <div className={style.container}>
      ...
      of Taffy Brodesser-Akner’s new novel from the production department at PRH
      here in NY.”) Fake Bettina declined to say anything over email about the
      name in question, other than to note that it was a common one. She wanted
      to print the damning email and send it via FedEx; when I suggested our
      company mailroom, she said the material was too sensitive for that. Could
      we provide a home address? “I’ll pay the postage of course,” the thief
      wrote.
    </div>
    <div className={style.container}>
      <Parallax speed={2}>
      ...
      and work accounts and to Lila’s. Each was a warped but nearly identical
      version of the others. Three of the four cut off mid-sentence; one ended
    ...
    <div className={style.container}>
      ...
      woke up to an overnight alert on my phone that someone was trying to log
    ...
    <div className={style.container}>
      ...
      pregnant, and every time she returned from a doctor’s appointment, she
